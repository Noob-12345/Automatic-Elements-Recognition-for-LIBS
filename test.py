...
def compute_element_confidence_shape(elements, peak_wl, peak_int,global_wl,global_intensity,scope=0.25):
    ...
    for element_name, element_data in elements.items():
        ...
        #theo_vec, exp_vec, matched_theo, matched_exp = match_spectral_lines(element_wl, element_intensity, peak_wl, peak_int, scope)
...
for I_element_name in I_elements_list:
    ...
    particle_result,elements_result,elements_T,elements_R2,elements_confidence=compute_element_confidence_shape(elements,
                                                                         peak_wl, peak_int,x,intensity_sum,scope=0.2)
    print("\n---" ,I_element_name, "---") 
    # # # 粒子
    # print("--- 粒子层面 ---\n")
